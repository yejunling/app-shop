...
// 父组件发送异步请求
  setDatas({commit}) {
    ...
    let data = {
      ...
      swiper:[
        {imgSrc:'./static/img/computer1.png',id:1},
        {imgSrc:'./static/img/computer2.png',id:2},
        {imgSrc:'./static/img/computer3.png',id:3},
      ],
    
      contentImgSrc:[
        {imgSrc:'./static/img/computer1.png'},
        {imgSrc:'./static/img/computer2.png'},
        {imgSrc:'./static/img/computer3.png'},
        {imgSrc:'./static/img/computer4.png'},
      ]
    };
